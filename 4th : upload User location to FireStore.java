...
4th : how to use it 
---------------------
you can call this method 'getUserDetails()' after getting permission with doSomething(); to get and upload the userlocation
    



------------------------------------------------------------------------------------------------------------
Models : i don't think the Parcelable is necessary 
--------------------------------------------------- */
